            ...
            <div class="container" v-for="(t, index) in relevant_tickets"  :key="index">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <p>{{ t.description }}</p>
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#faqModal" @click="this.selected_ticket=t.ticket_id"> Approve </button>
                    </div>
                    <div class="col-md-2">
                        <div class="row">
                        ...
                        <div class="row">
                            <button class="btn btn-danger" @click="rejectFAQ(t.ticket_id)"> Reject </button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" data-bs-dismiss="modal" @click="approveFAQ()">Submit</button>
      </div>
    </div>
  </div>
</div>
